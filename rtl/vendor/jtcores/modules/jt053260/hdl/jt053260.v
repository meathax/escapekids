...
module jt053260(
    ...
    input             [ 7:0] romd_data,
    output                   romd_cs,
    output            [20:0] ch0_start, ch1_start, ch2_start, ch3_start,
    output            [ 3:0] channel_sample, channel_bsy, channel_reverse,
...
assign channel_sample = {ch3_sample,ch2_sample,ch1_sample,ch0_sample};
assign channel_bsy = bsy;
assign channel_reverse = nib_swap;
