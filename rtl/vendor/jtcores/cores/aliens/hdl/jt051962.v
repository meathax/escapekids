...
module jt051962(
    ...
    // Escape Kids CCU timing bridge.  Unconnected for the donor modes.
    input      [ 8:0] ext_hdump,
    input      [ 8:0] ext_vdump,
...
wire [8:0] hdump_int, vdump_int, vrender_int, vrender1_int;
wire       lhbl_int, lvbl_int, hs_int, vs_int;
...
assign vs      = EXT_TIMING && ext_en ? ext_vs     : vs_int;
